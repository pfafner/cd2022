...
<div id='id-labs'/>
  ...
  **No.**  | **Fecha**    | **Tópicos**                                                         | **Material**
  ...
  12       | 05.02.2022   | Ejemplos de *mean-shift*, DBSCAN, OPTICS y BIRCH.                   | [density-based.ipynb](code/density-based.ipynb){:target="_blank"} [comparison.ipynb](code/comparison.ipynb){:target="_blank"}
