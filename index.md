...
<div id='id-material'/>
  ...
  **No.**  | **Fecha**    | **Tópicos**                                                         | **Actividades**
  ...
  37       | 18.05.2022   | El perceptrón. Máquinas de vectores de soporte (SVM). <br/> [Aula 33](aulas/Aula33.pdf){:target="_blank"} | [Tensorflow Playground](https://playground.tensorflow.org/){:target="_blank"} <br/> [Tensorflow Playground](https://playground.tensorflow.org/){:target="_blank"} 
...
<div id='id-labs'/>
  ...
  **No.**  | **Fecha**    | **Tópicos**                                                         | **Material**
  ...
  12       | 03.05.2022   | Ejemplos de *mean-shift*, DBSCAN, OPTICS y BIRCH.                   | [density-based.ipynb](code/density-based.ipynb){:target="_blank"} [comparison.ipynb](code/comparison.ipynb){:target="_blank"}
  13       | 03.05.2022   | Método de las *silhouettes*.                                        | [silhouette.ipynb](code/silhouette.ipynb){:target="_blank"}
  14       | 05.05.2022   | Ejemplo de KNN.                                                     | [knn.ipynb](code/knn.ipynb){:target="_blank"}
